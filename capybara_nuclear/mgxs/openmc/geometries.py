...
def rectangular_lattice(lattice_size: int, lattice_pitch: float, fuel_or: float,
                        fuel_material: openmc.Material | list[openmc.Material], clad_ir: float, clad_or: float, # type: ignore
